...
ENTRIES = {
    ...
    "C1-6": {
        ...
        "evidence_notes": "Well-validated with strong psychometrics. Most research correlational/cross-sectional. Real-time efficacy collapse dynamics more theoretical than experimentally demonstrated.",
    },
    "C1-7": {
    ...
    "C2-1": {
        ...
        "key_studies": [
            ...
            "Bhanji & Delgado (2014). Social Brain and Reward. WIREs Cognitive Science. Striatal response blunted for value-incongruent rewards.",
    ...
    "C2-5": {
        ...
        "decision_comp": "IF Approach_Force ~ Avoidance_Force THEN Net_Motivation ~ 0",
        ...
        "evidence_notes": "Miller's model validated with modern neuroscience. 'Net motivation = 0' is simplification; conflict produces oscillation and anxiety. DIFFERENTIATION: Distinct from C5-6 (Value Contradiction). C2-5 is motivational ambivalence (subcortical BIS activation) -- competing approach and avoidance drives produce oscillation and felt tension at the desire stage. Pre-reflective and emotional. Prevents commitment formation. DIAGNOSTIC: Do you feel pulled in two directions about wanting this at all, or have you committed but it conflicts with something else you believe in? Torn about wanting it → C2-5. Committed but clashes with another value → C5-6.",
    },
    "C2-6": {
    ...
    "C2-7": {
        ...
        "key_studies": [
            ...
            "Frankl (1963). Man's Search for Meaning. Beacon Press. Will to meaning as primary motive; absence = existential vacuum.",
            ...
            "Czekierda et al. (2017). Meaning in Life and Physical Health: Meta-Analysis. Health Psychology Review. Significant association with health outcomes mediated by motivated behaviors.",
        ],
        "evidence_level": "MODERATE",
        ...
        "evidence_notes": "Association well-documented but mostly correlational. Causal direction debated. Frankl influential but clinical/philosophical. Rated MODERATE due to cross-sectional evidence.",
    },
    "C2-8": {
    ...
    "C3-1": {
        ...
        "key_studies": [
            ...
            "Inzlicht & Schmeichel (2012). Process Model of Self-Control Fatigue. Social and Personality Psychology Compass. Motivation shift, not resource depletion.",
            "Berkman, Hutcherson & Inzlicht (2017). Self-Control as Value-Based Choice. Current Directions in Psychological Science. Self-control is dynamic value computation, not resource expenditure.",
        ],
        "evidence_level": "MODERATE",
    ...
    "C4-2": {
        ...
        "effect_size": "d = 0.5-0.7 (medium to large)",
        "key_studies": [
            "Sirois & Pychyl (2013). Procrastination and Short-Term Mood Regulation. SPPC. Planning can serve as mood-regulating substitute for action.",
        ...
        "evidence_notes": "'Dopaminergic reward from planning itself' theoretically grounded but lacks direct neuroimaging isolating planning-as-reward. Construct is synthesis, not independently studied phenomenon.",
    },
    "C4-3": {
        ...
        "key_studies": [
            ...
            "Schwartz (2004). Paradox of Choice. Harper Perennial. Maximizers experience greater paralysis.",
            "Chernev et al. (2015). Choice Overload: Meta-Analysis. JCP. Effect conditional on complexity, difficulty, preference uncertainty, goal clarity.",
    ...
    "C4-5": {
        ...
        "key_studies": [
            ...
            "Gollwitzer & Sheeran (2006). Implementation Intentions Meta-Analysis. AESP. 94 tests, d=0.65.",
        ],
        "evidence_level": "STRONG",
    ...
    "C4-6": {
        ...
        "key_studies": [
            ...
            "Tavris & Aronson (2007). Mistakes Were Made. Houghton Mifflin Harcourt. Self-justification is self-reinforcing 'pyramid of choice.'",
    ...
    "C5-2": {
        ...
        "key_studies": [
            ...
            "Neal et al. (2011). Perceived and Actual Triggers of Habits. JESP. Strong habits primarily influenced by context, not goals.",
        ...
        "evidence_notes": "Robust through experience sampling and diary studies. Most research on simple habitual behaviors, not complex goal pursuit.",
    },
    "C5-3": {
        ...
        "effect_size": "d = 0.4-0.6 (medium)",
        "key_studies": [
            "Matthews (2015). Impact of Commitment, Accountability, and Written Goals. Dominican University. Accountability doubled goal attainment (70% vs 35%).",
        ...
        "evidence_notes": "Matthews study is conference presentation, not peer-reviewed. Harkin et al. meta-analysis provides strongest quantitative evidence.",
    },
    "C5-4": {
        ...
        "key_studies": [
            ...
            "Ariely & Wertenbroch (2002). Procrastination, Deadlines, and Performance. Psychological Science. Self-imposed stakes improve performance.",
        ...
        "evidence_level": "STRONG",
        "moderating_factors": "Loss magnitude relative to goal value | Self-imposed vs externally imposed | Loss vs gain framing | Social vs material stakes",
        "evidence_notes": "Prospect theory Nobel-Prize-winning work. Gneezy & Rustichini provides critical boundary condition.",
    },
    "C5-5": {
        ...
        "evidence_notes": "Steel (2007) is most cited procrastination paper (5,000+ citations). Impulsivity strongest predictor (r=0.41, 95% CI [.37, .46], k=22, N=4,005).",
    },
    "C5-6": {
        ...
        "key_studies": [
            ...
            "Kegan & Lahey (2009). Immunity to Change. Harvard Business Press. Value contradictions create competing commitments.",
    ...
    "C5-8": {
        ...
        "intervention": "Reduce cost, Micro-starts, Monitor progress.",
        "effect_size": "d = 0.4-0.6 (medium)",
        "key_studies": [
        ...
        "evidence_level": "MODERATE",
        "moderating_factors": "Duration/magnitude of gap | Alternative dissonance-reduction strategies | Self-compassion (Neff 2003) | Attribution style",
        "evidence_notes": "Dissonance and self-discrepancy theories foundational. Specific accumulation dynamic less directly studied as named construct. Brandstatter provides strongest direct evidence. DIFFERENTIATION: Distinct from C5-7 (Identity Misalignment). C5-8 is RETROSPECTIVE/ACCUMULATED -- the person committed and attempted but repeated failure creates a widening gap between aspiration and action ('I keep saying I'll change but never do'). Brandstatter et al. (2013) show this triggers action crisis with cortisol elevation. DIAGNOSTIC: Is this goal something that doesn't fit who you are, or something you've been trying to do but keep falling short? Doesn't fit who I am → C5-7. Keep trying and failing → C5-8.",
    },
    ...
    "C6A-6": {
        ...
        "key_studies": [
            ...
            "Schwinger & Stiensmeier-Pelster (2021). Antecedents of Self-Handicapping: Meta-Analysis. 159 studies, N=81,630. Low self-esteem, performance-avoidance goals, entity theories strongest antecedents.",
    ...
    "C6A-7": {
        ...
        "evidence_notes": "Dopamine hypothesis well-supported by genetics, neuroimaging, pharmacology. 'Cold-start vs continuation' distinction clinically observed but not isolated as discrete experimental variable.",
    },
    "C6A-8": {
